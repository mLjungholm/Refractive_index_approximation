...
function [n,nf,shellR] = findRefractiveIndex(s,pp,ps,n0,steps)
n = zeros(s.nRays,1);
n(1) = n0;
shellR = pp(1:end);
shellR = shellR;
...
%         close all
        ...
        threshold = 0.0001;  % Threshold value
...
%             pathInShell = zeros(3,1);
            ...
            while ~exitVolume && rayStep < maxSteps
                ...
                if cShell == rayInd
                    ...
                    phaseSum = phaseSum + phaseShiftKnownGradient((r0+r1)/2,cShell);
                end                   
